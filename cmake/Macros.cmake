macro(media_rtp_support_option DESCRIPTION OPTIONNAME DEFINENAME DEFAULTVALUE EMPTYVALUE)
...
endmacro(media_rtp_support_option)

macro(media_rtp_include_test INCFILE DEFINENAME EMPTYVALUE)
	check_include_file_cxx(${INCFILE} media_rtp_include_test_${DEFINENAME})
	if (media_rtp_include_test_${DEFINENAME})
		set(${DEFINENAME} "#define ${DEFINENAME}")
	else (media_rtp_include_test_${DEFINENAME})
		set(${DEFINENAME} "${EMPTYVALUE}")
	endif (media_rtp_include_test_${DEFINENAME})
endmacro(media_rtp_include_test)

macro (media_rtp_test_feature FILENAME DEFINENAME INVERT EMPTYVALUE EXTRADEFS) 
...
endmacro (media_rtp_test_feature)
